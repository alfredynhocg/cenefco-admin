...
@Component({
  selector: 'app-ejecucion-create',
  imports: [NgIcon, PageTitle, RouterLink, ReactiveFormsModule],
  templateUrl: './ejecucion-create.html',
  styles: ``
})
export class EjecucionCreate {
  ...
  onSubmit(): void {
    ...
    this.ejecucionService.create(payload).subscribe({
      next: () => {
        this.toast.success('¡Registrado!', 'Ejecución presupuestaria registrada');
