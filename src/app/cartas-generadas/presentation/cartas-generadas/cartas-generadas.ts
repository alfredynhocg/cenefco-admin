...
type ApiState = { type: 'loading' } | { type: 'success'; response: CartaGeneradaListResponse } | { type: 'error' };
const LOADING: ApiState = { type: 'loading' }; const ERROR: ApiState = { type: 'error' };

@Component({ selector: 'app-cartas-generadas', imports: [NgIcon, Pagination, PageTitle, RouterLink], templateUrl: './cartas-generadas.html' })
